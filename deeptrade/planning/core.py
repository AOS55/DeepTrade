...
def complete_agent_cfg(
    env: Union[gym.Env, deeptrade.models.ModelEnv], agent_cfg: omegaconf.DictConfig
):
...
def load_agent(agent_path: Union[str, pathlib.Path], env: gym.Env) -> Agent:
    ...
    if cfg.algorithm.agent._target_ == "deeptrade.third_party.pytorch_sac_pranz24.sac.SAC":
        import deeptrade.third_party.pytorch_sac_pranz24 as pytorch_sac
