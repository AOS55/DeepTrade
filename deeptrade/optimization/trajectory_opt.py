...
class CEMOptimizer(Optimizer):
    ...
    def _sample_population(
        ...
        if self._clipped_normal:
            ...
            population = deeptrade.util.math.truncated_normal_(population)
    ...
    def optimize(
        ...
        **kwargs,
        ...
        for k in range(self.refinements):
            ...
            noise = deeptrade.util.math.truncated_normal_(noise)
    ...
    def optimize(
        ...
        **kwargs,
        ...
        for i in range(self.num_iterations):
            ...
            population = deeptrade.util.math.powerlaw_psd_gaussian(
...
class TrajectoryOptimizerAgent(Agent):
    ...
    def __init__(
        ...
        self.trajectory_eval_fn: deeptrade.types.TrajectoryEvalFnType = None
        self.actions_to_use: List[np.ndarray] = []
        self.replan_freq = replan_freq
        self.verbose = verbose

    def set_trajectory_eval_fn(
        self, trajectory_eval_fn: deeptrade.types.TrajectoryEvalFnType
    ):
...
def create_trajectory_optim_agent_for_model(
    ...
    using :meth:`deeptrade.models.ModelEnv.evaluate_action_sequences` as its objective function.


    Args:
        model_env (deeptrade.models.ModelEnv): the model environment.
