...
class Normalizer:
    ...
    def update_stats(self, data: deeptrade.types.TensorType):
    ...
    def normalize(self, val: Union[float, deeptrade.types.TensorType]) -> torch.Tensor:
    ...
    def denormalize(self, val: Union[float, deeptrade.types.TensorType]) -> torch.Tensor:
