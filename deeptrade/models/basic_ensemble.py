...
class BasicEnsemble(Ensemble):
    ...
    :class:`deeptrade.models.Ensemble`, for example :class:`deeptrade.models.GaussianMLP`.
    ...
    The underlying model can be any subclass of :class:`deeptrade.models.Model`, and the ensemble
    ...
    :class:`deeptrade.models.Model`. This method assumes that the models have an attribute
