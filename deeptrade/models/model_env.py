...
class ModelEnv:
    ...
    Args:
        ...
        model (:class:`deeptrade.models.Model`): the model to wrap.
    ...
    def __init__(
        ...
        env: gym.Env,
        model: Model,
        termination_fn: deeptrade.types.TermFnType,
        reward_fn: Optional[deeptrade.types.RewardFnType] = None,
    ...
    def reset(
        ...
        """
        if isinstance(self.dynamics_model, deeptrade.models.OneDTransitionRewardModel):
    ...
    def step(
        self,
        actions: deeptrade.types.TensorType,
        model_state: Dict[str, torch.Tensor],
        sample: bool = False,
    ) -> Tuple[deeptrade.types.TensorType, deeptrade.types.TensorType, np.ndarray, Dict]:
        ...
        with torch.no_grad():
            ...
            # print(f"self.reward_fn: {self.reward_fn}")
            # print(f"step rewards: {rewards.shape}")
