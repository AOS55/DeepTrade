...
from deeptrade.util.logger import Logger
from deeptrade.util.replay_buffer import BootstrapIterator, TransitionIterator
...
class ModelTrainer:
    ...
    Args:
        model (:class:`deeptrade.models.Model`): a model to train.
        optim_lr (float): the learning rate for the optimizer (using Adam).
        weight_decay (float): the weight decay to use.
        logger (:class:`deeptrade.util.Logger`, optional): the logger to use.
    """
    ...
    def train(
        ...
        Args:
            dataset_train (:class:`deeptrade.util.TransitionIterator`): the iterator to
                use for the training data.
            dataset_val (:class:`deeptrade.util.TransitionIterator`, optional):
    ...
    def evaluate(
        ...
        :meth:`deeptrade.models.Model.eval_score` to compute the model score
