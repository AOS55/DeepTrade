...
from deeptrade.models.util import to_tensor
from deeptrade.types import ModelInput, TransitionBatch
...
class Ensemble(Model, abc.ABC):
    ...
    def reset(
        ...
        """Prepares the model for simulating using :class:`deeptrade.models.ModelEnv`."""
        raise NotImplementedError(
